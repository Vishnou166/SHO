...
export function SELECTTIMINGS ({navigation}) {
  	...
  	return (
    		<View style={styles.assignPage4}>
      			...
      			<Text style={[styles.selectTimings, styles.selectTypo]}>Select timings</Text>
      			<Text style={[styles.selectOfficers, styles.selectTypo]}>Select officers</Text>
      			<Pressable style={[styles.wrapper, styles.wrapperLayout]} onPress={()=>{}}>
        				<Image style={styles.icon} resizeMode="cover" /*source="Frame 21.png"*/ />
      			</Pressable>
      			<Image style={[styles.assignPage4Child3, styles.wrapperLayout]} resizeMode="cover" /*source="Frame 22.png"*/ />
      			<View style={[styles.assignPage4Child4, styles.rectangleViewPosition]} />
      			<Pressable style={styles.confirm} onPress={()=>{navigation.navigate("Select");}}>
