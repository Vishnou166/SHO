...
export function SELECT ({navigation}) {
  	...
  	return (
    		<View style={styles.assignPage3}>
      			...
      			<Text style={[styles.selectTimings, styles.selectTypo]} onPress={()=>{navigation.navigate("SelectTimings");}} >Select timings</Text>
      			<Text style={[styles.selectOfficers, styles.selectTypo]} onPress={()=>{navigation.navigate("SelectOfficers");}}>Select officers</Text>
      			<Pressable style={[styles.wrapper, styles.wrapperLayout]} onPress={()=>{}}>
        				<Image style={styles.icon} resizeMode="cover" /*source="Frame 21.png"*/ />
      			</Pressable>
      			<Pressable style={[styles.container, styles.wrapperLayout]} onPress={()=>{}}>
        				<Image style={styles.icon} resizeMode="cover" /*source="Frame 22.png"*/ />
      			</Pressable>
      			<View style={[styles.assignPage3Child3, styles.rectangleViewPosition]} />
      			<Pressable style={styles.confirm} onPress={()=>{navigation.navigate("DashBoard");}}>
