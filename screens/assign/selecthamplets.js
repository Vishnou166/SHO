...
export function SELECTHAMPLETS ({navigation}) {
  	...
  	return (
    		<View style={styles.assignPage2}>
      			...
      			<Text style={[styles.selectBeatSubdivisions, styles.beatTypo]}>Select Beat-subdivisions</Text>
      			<Pressable style={[styles.rectanglePressable, styles.assignChildLayout1]} onPress={()=>{navigation.navigate("Select");}} />
      			<Pressable style={[styles.assignPage2Child2, styles.assignChildLayout1]} onPress={()=>{navigation.navigate("Select");}} />
      			<Pressable style={[styles.assignPage2Child3, styles.assignChildLayout1]} onPress={()=>{navigation.navigate("Select");}} />
      			<Pressable style={[styles.assignPage2Child4, styles.assignChildLayout]} onPress={()=>{navigation.navigate("Select");}} />
      			<Pressable style={[styles.assignPage2Child5, styles.assignChildLayout]} onPress={()=>{navigation.navigate("Select");}} />
