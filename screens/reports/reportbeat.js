...
export function REPORTBEAT ({navigation}) {
  	...
  	return (
    		<View style={styles.reportPage1}>
      			...
      			<Text style={[styles.reportFromOfficer3, styles.reportTypo]}>Report from officer X</Text>
      			<Text style={[styles.reportFromOfficer4, styles.reportTypo]}>Report from officer Y</Text>
      			<Text style={[styles.reportFromOfficer5, styles.previousReportsPosition]}>Report from officer Z</Text>
      			<Pressable style={[styles.previousReports, styles.previousReportsPosition]} onPress={()=>{navigation.navigate("Previous");}}>
