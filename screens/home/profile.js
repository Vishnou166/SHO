...
export function PROFILE({ navigation }) {
  return (
    <View style={styles.profile}>
      ...
      <Text
        style={[styles.telephoneDirectory, styles.helpTypo]}
        onPress={() => {
