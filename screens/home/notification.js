...
export function NOTIFICATIONS ({navigation})  {
  	...
  	return (
    		<View style={styles.notifications}>
      			...
      			<Text style={[styles.officer1, styles.officerPosition]}>{`OFFICER 1 `}</Text>
      			<Text style={[styles.beatOfficer, styles.officerPosition]}>Beat Officer</Text>
      			<Text style={[styles.dearOfficerI1, styles.alertTypo]}>                       Dear officer, I have completeed the tasks that has been...</Text>
    		</View>);
};
